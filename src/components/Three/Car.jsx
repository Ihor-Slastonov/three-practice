...
Command: npx gltfjsx@6.2.16 car.glb -T --shadows 
Files: car.glb [61.86MB] > D:\projects\Tests\three-practice\public\car-transformed.glb [3.05MB] (95%)
...
export function Car() {
  const { nodes, materials } = useGLTF("/three-practice/car-transformed.glb");
  return (
    <group dispose={null} scale={1} position={[-1, 0, -5]}>
      <mesh
        castShadow
        receiveShadow
...
useGLTF.preload("/three-practice/car-transformed.glb");
